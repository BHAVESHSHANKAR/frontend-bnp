                        ...
                        <div key={index} className="p-6">
                            <div className="flex items-center justify-between">
                                <div className="flex items-center space-x-3">
                                    ...
                                    <div>
                                        <h4 className="text-sm font-medium text-gray-900">Customer ID: {decision.customer_id}</h4>
                                        <p className="text-sm text-gray-500">Decision: {new Date(decision.decision_timestamp).toLocaleDateString()}</p>
                                    </div>
                                </div>
